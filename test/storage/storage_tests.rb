...
module StorageTests
  ...
  def test_authenticate
    EMLoop.new do
      ...
      assert_equal 'follower1@wonderland.lit', user.roster[0].jid.to_s
      assert_equal 'Follower1', user.roster[0].name
      ...
      assert_equal 'follower2@wonderland.lit', user.roster[1].jid.to_s
      assert_equal 'Follower2', user.roster[1].name
  ...
  def test_save_user
    EMLoop.new do
      ...
      user.roster << Vines::Follower.new(
        :jid => 'follower1@domain.tld/resource2',
        :name => 'Follower 1')
      db.save_user(user)
      ...
      assert_equal 'follower1@domain.tld', user.roster[0].jid.to_s
      assert_equal 'Follower 1', user.roster[0].name
    end
  end
