    ...
    class Presence
      class Subscribed < Presence
        ...
        def process_inbound
          ...
          follower = user.follower(stream.user.jid) if user
          return unless follower && follower.can_subscribe?
          follower.subscribe_to
        ...
        # After approving a follower's subscription to this user's presence,
        # broadcast this user's most recent presence stanzas to the follower.
